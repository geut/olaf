...
module.exports = class InputMsg extends Component {
  ...
  sendMessage = (e) => {
    ...
    const input = this.element.querySelector('#chat-msg')
        ...
        <form class="mw7 center pa4 br2-ns ba b--black-10">
          <fieldset class="cf bn ma0 pa0">
            <div class="cf">
              ...
              <input class="f6 f5-l input-reset bn fl pa3 lh-solid w-100 w-75-m w-80-l br2-ns br--left-ns"
                placeholder="Message..."
                autofocus type="text" name="chat-msg"
                id="chat-msg">
